# -*- coding: utf-8 -*-
"""Copy of frcnn_test_vgg.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UAZFFopL4tesMB158l3l7mSGbBiMIaTf
"""
...
def rpn_to_roi(rpn_layer, regr_layer, C, dim_ordering, use_regr=True, max_boxes=300,overlap_thresh=0.5):
...
base_path = '/content/drive/My Drive/Snake Identification/files'

test_path = os.path.join(base_path, 'test_annotation.txt') # Test data (annotation file)

test_base_path = '/content/drive/My Drive/Snake Identification/images/test' # Directory to save the test images
...
for file in os.listdir(test_base_path):
	if file.lower().endswith(('.bmp', '.jpeg', '.jpg', '.png', '.tif', '.tiff')):
		test_imgs.append(file)
print(test_imgs)

imgs_path = test_imgs.copy()
'''
for i in range(len(test_imgs)):
	
	idx = np.random.randint(len(test_imgs))
	# if test_imgs[idx].lower().endswith(('.bmp', '.jpeg', '.jpg', '.png', '.tif', '.tiff')):
...
for idx, img_name in enumerate(imgs_path):
    ...
    for key in bboxes:
        ...
        new_boxes, new_probs = non_max_suppression_fast(bbox, np.array(probs[key]), overlap_thresh=0.9)
